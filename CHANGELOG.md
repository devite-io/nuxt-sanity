...
- Listen for property changes ([dba7d47](https://github.com/devite-io/nuxt-sanity/commit/dba7d47))
...
- Deduplicate sanity requests ([36fb2ac](https://github.com/devite-io/nuxt-sanity/commit/36fb2ac))
...
- Exported types ([0b4e72d](https://github.com/devite-io/nuxt-sanity/commit/0b4e72d))

### 🏡 Chore

- Update dependencies ([c19b2bf](https://github.com/devite-io/nuxt-sanity/commit/c19b2bf))
...
- Update dependencies ([7b32943](https://github.com/devite-io/nuxt-sanity/commit/7b32943))
...
- Add nitro auto imports ([019be76](https://github.com/devite-io/nuxt-sanity/commit/019be76))

### 🏡 Chore

- **playground:** Add fields for sitemaps ([4d9911d](https://github.com/devite-io/nuxt-sanity/commit/4d9911d))
...
[compare changes](https://github.com/devite-io/nuxt-sanity/compare/v2.8.1...v2.8.2)

### 🩹 Fixes

- Allow nuxt preview without ssl for visual editing ([bdb677a](https://github.com/devite-io/nuxt-sanity/commit/bdb677a))

### 💅 Refactors

- Remove dependency optimization warning + remove unnecessary condition ([f596765](https://github.com/devite-io/nuxt-sanity/commit/f596765))

### 🏡 Chore

- Update dependencies ([d551073](https://github.com/devite-io/nuxt-sanity/commit/d551073))
